...
|---|---|---|
| 对接助理 | tem_merchant_contacts.contact_assistant | 按 brand_id 关联商户对接表（**2026-06-17 起跟进总表 `DWUxvdFNHQXpWd0ZO` 拆为 E"原-对接助理" + F"新-对接助理"，sync_all.py 取 F 列「新-对接助理」**） |
...
### tem_sp_assignments（服务商分工 · 2026-06-17 更新）

来源 `DWVRiUGNCTUJhTHVv` 第 1 个 sheet，D 列「负责人」为权威字段。`sync_all.py --table sp` 写入。

| 服务商 | 分类 | 目标腰部数 | 负责人 | 报名返佣 |
|---|---|---|---|---|
| 企迈 | SaaS服务商 | 180 | 罗老师 | 是 |
| 天财商龙 | SaaS服务商 | 180 | 振哥 | 是 |
| 盈动易象 | SaaS服务商 | 10 | 罗老师 | 是 |
| 银豹 | SaaS服务商 | 20 | 振哥 | 是 |
| 全来店 | SaaS服务商 | 50 | 小蛇 | 是 |
| FLIPOS | SaaS服务商 | 20 | 罗老师 | 否 |
| 奥琦玮 | SaaS服务商 | 10 | 振哥 | 是 |
| 美团 | SaaS服务商 | 260 | 振哥、小蛇 | 否 |
| 有好 | SaaS服务商 | 8 | 振哥 | 否 |
| 食亨 | SaaS服务商 | 2 | 振哥 | 否 |
| 扫呗 | 经营服务商 | 10 | 振哥、小蛇 | 是，平台产品能力未 ready |
| 乐世微广 | 经营服务商 | 8 | 振哥、小蛇 | 是，平台产品能力未 ready |
| 米雅 | 经营服务商 | 2 | 振哥、小蛇 | 是，平台产品能力未 ready |
| 收钱吧 | 经营服务商 | 10 | 振哥、小蛇 | 是，平台产品能力未 ready |
| 自研 | 经营服务商 | 30 | 振哥、小蛇 | 否 |
